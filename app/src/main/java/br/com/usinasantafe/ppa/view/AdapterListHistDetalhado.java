...
public class AdapterListHistDetalhado extends BaseAdapter {
    ...
    public AdapterListHistDetalhado(Context context, List itens) {
        this.itens = itens;
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        view = layoutInflater.inflate(R.layout.activity_item_hist_detalhado, null);
